...
public class SearchLocation {
    ...
    public void prepData(ArrayList<Point> pointArray) {
        ...
        StrattonHall.add("SH");
        StrattonHall.add("Stratton Hall");
        StrattonHall.add("Stratton");
        BoyntonHall.add("BH");
        BoyntonHall.add("Boynton Hall");
        BoyntonHall.add("Boynton");
        SalisburyLabs.add("SL");
        SalisburyLabs.add("Salisbury Labs");
        SalisburyLabs.add("Salisbury");
        GordonLibrary.add("GL");
        GordonLibrary.add("Gordon Library");
        GordonLibrary.add("Library");
        CampusCenter.add("CC");
        CampusCenter.add("Campus Center");
        CampusCenter.add("Rubin Campus Center");
        HigginsLabs.add("HL");
        HigginsLabs.add("Higgins Labs");
        HigginsLabs.add("Higgins");
        FullerLabs.add("FL");
        FullerLabs.add("Fuller Labs");
        FullerLabs.add("Fuller");
        KavenHall.add("KH");
        KavenHall.add("Kaven Hall");
        KavenHall.add("Kaven");
        HigginsHouse.add("HH");
        HigginsHouse.add("Higgins House");
        HigginsHouse.add("Grandma's House");
        WashburnShops.add("WB");
        WashburnShops.add("Washburn Shops");
        WashburnShops.add("Washburn");
        AldenHall.add("AH");
        AldenHall.add("Alden Hall");
        AldenHall.add("Alden");
        OlinHall.add("OH");
        OlinHall.add("Olin Hall");
        OlinHall.add("Olin");
        West157.add("SDCC");
        West157.add("157 West");
        West157.add("157");
        Campus.add("Campus");
        AlumniGym.add("AG");
        AlumniGym.add("Alumni Gym");
        AlumniGym.add("Alumni");
        ProjectCenter.add("PC");
        ProjectCenter.add("Project Center");
        ProjectCenter.add("CDC");
        AtwaterKent.add("AK");
        AtwaterKent.add("Atwater Kent");
...
*/
    ...
    public static String searchFor(String searchTerm) {
        if (searchTerm.length() != 0) {
            ...
            Collections.sort(orderList, new orderListComparator());
